...
from load_data import load_wikiQA_corpus, load_word2vec_to_init, load_mts_wikiQA, load_wmf_wikiQA
from word2embeddings.nn.util import zero_value, random_value_normal
from common_functions import Conv_with_input_para, Average_Pooling_for_Top, create_conv_para, create_GRU_para, GRU_Matrix_Input, Average_Pooling, Diversify_Reg,Matrix_Bit_Shift, GRU_Batch_Tensor_Input, compute_simi_feature_matrix_with_matrix, unify_eachone, Determinant
