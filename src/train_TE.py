...
from load_data import load_entailment_corpus , load_word2vec_to_init#, load_mts_wikiQA, load_wmf_wikiQA
...
def evaluate_lenet5(learning_rate=0.05, n_epochs=2000, nkerns=[50,50], batch_size=1, window_width=3,
    ...
    rootPath='/mounts/data/proj/wenpeng/Dataset/StanfordEntailment/';
    rng = numpy.random.RandomState(23455)
    datasets, vocab_size=load_entailment_corpus(rootPath+'vocab_lower_in_word2vec.txt', rootPath+'train.txt', rootPath+'test.txt', max_truncate,maxSentLength)#vocab_size contain train, dev and test
    ...
    indices_train, trainY, trainLengths, normalized_train_length, trainLeftPad, trainRightPad, train_size= datasets[0]
    ...
    indices_test, testY, testLengths,normalized_test_length, testLeftPad, testRightPad, test_size= datasets[1]
